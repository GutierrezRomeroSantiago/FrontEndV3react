...
export function ChatPage(){
    ...
    >
        ...
        <form onSubmit={b} sx={{postion:"fixed"}}>
            {/* <input onChange={a} type="text" placeholder="Escribe un mensaje" value={message}/> */}
            <TextField sx={{width: "95%", padding: "5px", margin: "5px"}}  variant="standard" onChange={a} type="text" placeholder="Escribe un mensaje" value={message} />
        </form>
